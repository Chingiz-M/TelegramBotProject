...
namespace TelegramBotProject.Services
{
    internal class CompMethods : ICompMethods
    {
        ...
        private string WindowsInstruction = "Инструкция для Windows 10/11:\n\n" +
                        "1. Скачайте ваш файл *.p12 и установочный cmd-скрипт на ваш ПК, поместив их вместе в отдельную папку.\n" +
                        ...
                        "4. В черном окне терминала по запросу введите ip-адрес вашего сервера (набор из 4-х чисел, разделенных точками).\n" +
                        "5. Установленный VPN отобразится в полосе Пуск внутри иконки \"Сеть\", в правом нижнем углу экрана.\n" +
                        "6. Подключите VPN, нажав на соответствующую кнопку.";
