              ...
              .ConfigureServices((context, services) => {
                  ...
                  services.AddTransient<SOCKSServiceResolver>(serviceProvider => key =>
                  {
                      switch (key)
                      {
                          ...
                          case "SOCKS_6":
                              return serviceProvider.GetService<Socks_6>();
                          default:
                  ...
                  services.AddTransient<IPsec_15>();
                  ...
                  services.AddTransient<IPSecServiceResolver>(serviceProvider => key =>
                  {
                      switch (key)
                      {
                          ...
                          case "IPSEC_8":
                              return serviceProvider.GetService<IPsec_8>();
                          case "IPSEC_9":
                          ...
                          case "IPSEC_15":
                              return serviceProvider.GetService<IPsec_15>();
                          default:
                              throw new KeyNotFoundException(); // or maybe return null, up to you
                      }
                  });
